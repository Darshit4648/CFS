 ...
 //echo $f_id;
  $qry1="select * from farmer where f_id='$data'";
   ...
   $data2=mysqli_fetch_assoc($rs3);
     echo $totproduction=$data2["totalproduction"];
...
echo "<div class='form-group'>";
	echo "<label>rawmaterial total price:</label>";
	echo "<input type='text' class='form-control'  name='txtrawprice' placeholder='Enter your Material Name' value='".$total."' required readonly>";
	echo "</div>";
	 echo "<div class='form-group'>";
