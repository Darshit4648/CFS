...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2019 at 11:25 PM
...
(46, 21, 3, '2019-08-12', '4000', ' 6 months.', 1, '05/09/2019 02:45:30', 1),
(47, 21, 9, '2019-08-23', '4000', '6 months.', 1, '05/09/2019 02:45:30', 0),
(48, 30, 1, '2019-09-04', '4000', '6 months.', 1, '04/09/2019 03:44:54', 1),
(49, 21, 9, '2019-09-05', '4000', '5 months.', 0, '05/09/2019 02:45:30', 0),
(50, 21, 9, '2019-09-05', '4000', '5 months.', 0, '05/09/2019 02:45:30', 0);
...
(8, 21, 3, '2019-09-03', 'Fertilizers', 'urea', '3', 1);
...
(30, 'sihvam', 'ahmedabad', '23.04108288344875', '72.51624881674172', '12', '104', '9087132121', 'potato', '2000', 'shivam', 'shivam@12');
...
(13, 21, 3, '2019-09-03', '48000', 1, '03/09/2019 10:49:14'),
(14, 30, 1, '2019-09-04', '64000', 0, '');
...
(32, 3, 21, 'Fertilizers', 'urea', '3', '2000', '6000', 1, '2019-08-03 12:43:35', '03/09/2019 10:57:07'),
(33, 3, 21, 'Pesticides', 'amonium sulphate', '2', '2000', '4000', 1, '2019-08-03 12:43:35', '03/09/2019 10:57:07'),
...
(12, 21, 3, '12', '03/09/2019 10:38:03'),
...
--
ALTER TABLE `acceptreq`
  MODIFY `ac_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `farmsalary`
  MODIFY `fa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `rawmaterial`
  MODIFY `rm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `transportcharges`
  MODIFY `ta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
